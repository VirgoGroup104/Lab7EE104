...
def draw():
    ...
    if not game_over:  
        ...
        right.draw()
        left.draw()
        screen.draw.text("Player1 Score: " +     
                         str(score), color="black",
                         topleft=(10, 10))
        screen.draw.text("Player2 Score: " +     
        ...
        if show_countdown:                             
            ...
            if (rounds % 2 == 0):      
                screen.draw.text("Player1's turn", color="black",
                             topleft=(CENTER_X - 150, 90), fontsize=60)
            else:                      
                screen.draw.text("Player2's turn", color="black",
                             topleft=(CENTER_X - 150, 90), fontsize=60)
        ...
        screen.clear()
        screen.blit("stage", (0, 0))
        screen.draw.text("Score for player1: " +   
                         str(score), color="black",
                         topleft=(10, 10))
        screen.draw.text("Score for player2: " +   
                         str(score1), color="black",
                         topleft=(600, 10))
        ...
        if (score > score1):  
            screen.draw.text("Player1 won", color="red",    
                             topleft=(CENTER_X - 120, 100), fontsize=60)
        elif (score < score1): 
            screen.draw.text("Player2 won", color="red",
                             topleft=(CENTER_X - 120, 100), fontsize=60)
        elif (score == score1):
            screen.draw.text("Even", color="red",
                             topleft=(CENTER_X - 50, 100), fontsize=60)
